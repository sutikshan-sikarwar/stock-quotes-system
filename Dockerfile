...
COPY stock-quotes-system /springbootprojects/stock-quotes-system
...
ENTRYPOINT ["java", "-jar", "/springbootprojects/stock-quotes-system"]

# Optional: set environment variables for customization
# ENV SPRING_PROFILES_ACTIVE=prod

# Run the Spring Boot application
CMD ["java", "-jar", "/springbootprojects/stock-quotes-system"]
